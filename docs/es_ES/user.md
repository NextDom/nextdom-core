...
permitido para conectarse a NextDom sino también sus derechos
director
...
-   ** ** Sólo local: Permite la conexión del usuario
    sólo si la red local NextDom

-   ** ** Perfiles: Seleccione el perfil de usuario:

    -   Administrador ** ** recibe toda NextDom derechos
...
-   ** ** Fecha de la última conexión: Fecha de la última conexión
    el usuario NextDom. Atención aquí es la fecha de conexión
