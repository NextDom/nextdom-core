El sistema de interacción en NextDom permite acciones
...
modelo de generación que permitirá NextDom para crear uno o más
...
NextDom tener varias respuestas a una sola pregunta).
