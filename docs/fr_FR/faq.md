NextDom nécessite-t-il un abonnement ? 
=====================================

Non, NextDom est pleinement utilisable sans aucune nécessité de quelque
...
NextDom utilise-t-il des serveurs extérieurs pour fonctionner ? 
==============================================================

Non, NextDom n’utilise pas d’infrastructure type "Cloud". Tout se fait en
...
sauvegarde en ligne ou le DNS NextDom nécessitent l’utilisation de nos
serveurs.
...
NextDom possède une version mobile adaptée à l’utilisation sur mobile et
...
Lors de votre première connexion à NextDom (et même après si vous ne les
...
Peut-on mettre NextDom en https ? 
================================

Oui : \* Soit vous avez un pack power ou plus, dans ce cas il vous
suffit d’utiliser le DNS NextDom. \* Soit avez un DNS et vous savez
