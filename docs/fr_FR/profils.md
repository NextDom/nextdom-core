...
NextDom spécifiques à l’utilisateur : page d’accueil, thèmes de la
...
-   **Desktop** : thèmes à utiliser en mode desktop, attention seul le
    thème par défaut est officiellement supporté par NextDom
...
-   **Général**
    ...
    -   **Afficher les menus** : indique à NextDom d’afficher le panneau
...
connecte sans authentification) à votre NextDom ainsi que la date de
