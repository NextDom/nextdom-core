NextDom provides developers and users with an API
complete to be able to drive NextDom from any object
logged.
...
> **Note**
>
> For all this documentation, \ #IP \ _NEXTDOM \ # corresponds to your url
> access to NextDom. This is (unless you are connected to your network
> local) of the internet address you use to access NextDom
> from the outside.
...
> and% 5D). The return of NextDom will be a json
...
-   **query**: question to ask to NextDom

-   **utf8** \ [optional]: tells NextDom whether to encode query
    in utf8 before trying to answer

-   **emptyReply** \ [optional]: 0 for NextDom to answer even if he
...
Here is the URL =
[Http: // \ #IP \ _NEXTDOM \ # / nextdom / core / api / jeeApi.php apikey = \ #APIKEY \ # & type = & category = Message \ #category \ # & message = \ #message \ #?] (Http: //#IP_NEXTDOM#/nextdom/core/api/jeeApi.php?apikey=#APIKEY#&type=message&category=#CATEGORY#&message=#MESSAGE#)
...
Returns in json the list of all NextDom objects
