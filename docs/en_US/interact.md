The interaction system in NextDom allows actions to be
...
generator model that will allow NextDom to create one or more
...
NextDom to have several answers for one and the same question).
