 ...
 */
 ...
 autoCompleteAction = ['report','sleep', 'variable', 'scenario', 'stop', 'wait','gotodesign','log','message','equipment','ask','nextdom_poweroff','scenario_return','alert','popup','icon','event','remove_inat'];
