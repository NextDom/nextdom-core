...
<header id="nextdom-header" class="navbar navbar-fixed-top navbar-default reportModeHidden">
    <div class="container-fluid">
        ...
        <nav class="navbar-collapse collapse">
            <div class="collapse navbar-collapse navbar-left col-lg-4 col-md-4" style="margin-left:25px">
                <ul class="nav navbar-nav">
                    <li class="dropdown cursor">
                        <a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-home fa-3x"></i><br>
                            <span class="hidden-xs hidden-sm hidden-md">{{Accueil}}</span> <b class="caret"></b></a>
                        ...
                        <li class="dropdown cursor">
                            <a data-toggle="dropdown"><i class="fa fa-stethoscope fa-3x"></i><br><span class="hidden-xs hidden-sm hidden-md">{{Analyse}}</span> <b class="caret"></b></a>
                        ...
                        if (Status::isConnectAdmin()) {
                            ...
                            <li class="dropdown cursor">
                                ...
                                <li class="dropdown cursor">
                                    <a data-toggle="dropdown"><i class="fa fa-tasks fa-3x"></i><br> <span
                                        ...
                                        <?php if (Status::isConnectAdmin()) {
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a href="index.php?v=m" class="noOnePageLoad"><i class="fa fa-mobile"></i> {{Versionmobile}}</a></li>
                                                    ...
                                                    <li><a id="bt_getHelpPage" class="cursor" data-plugin="<?php echo init('m'); ?>"data-page="<?php echo init('p'); ?>" title="{{Aide sur la page en cours}}"><i class="fa fa-question-circle"></i></a></li>
                                                    <?php if (Status::isConnectAdmin()) {
                                                        ?>
                                                        <li>
                                                            <?php if (isset($plugin) && is_object($plugin) && $plugin->getIssue() != '') {
                                                                ?>
                                                                <a target="_blank" href="<?php echo $plugin->getIssue() ?>" title="{{Envoyer un rapport de bug}}"><i class="fa fa-exclamation-circle"></i></a>
                                                            <?php } else { ?>
