...
?>
  ...
  <a class="btn btn-default pull-right btn-sm" id="bt_cmdConfigureLogRealTime"><i class="fas fa-file-alt">&nbsp;&nbsp;</i>{{Log}}</a>
...
$elements = explode(';', $cmd->getConfiguration('listValue', ''));
    ...
    ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-4">
                      <span class="label label-primary txtSizeNormal"><?php echo $cmd->getCache('value') ?></span>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-xs-4 control-label">{{Date collecte}}</label>
                    <div class="col-xs-4">
                      <span class="label label-primary txtSizeNormal"><?php echo $cmd->getCache('collectDate') ?></span>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-xs-4 control-label">{{Date valeur}}</label>
                    <div class="col-xs-4">
                      <span class="label label-primary txtSizeNormal"><?php echo $cmd->getCache('valueDate') ?></span>
                    </div>
                  </div>
                  <?php }?>
                </fieldset>
...
<?php if ($cmd->getType() == 'info' && $NEXTDOM_INTERNAL_CONFIG['cmd']['type']['info']['subtype'][$cmd->getSubType()]['isHistorized']['visible']) {
 ...
 <form class="form-horizontal">
  ...
  <?php if ($NEXTDOM_INTERNAL_CONFIG['cmd']['type']['info']['subtype'][$cmd->getSubType()]['isHistorized']['canBeSmooth']) {?>
  <div class="form-group">
