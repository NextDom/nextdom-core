    ...
    <div class="bs-sidebar nav nav-list bs-sidenav" >
        <center>
            <span class="btn btn-default btn-file">
                <i class="fa fa-cloud-upload"></i> {{Appliquer un template}}<input id="bt_uploadScenarioTemplate" type="file" name="file" data-url="core/ajax/scenario.ajax.php?action=templateupload&nextdom_token=<?php echo ajax::getToken(); ?>" style="display : inline-block;">
            </span>
        </center>
        <br/>
<?php
