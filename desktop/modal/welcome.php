...
<div class="callout callout-success" style="margin-bottom: 0!important;">
    ...
    {{  Bienvenue dans}} <?= config::byKey('product_name'); ?> {{, merci d'avoir choisi cet outil pour votre habitat connecté.}}<br>      
</div>
<br>
<div class="container">
	<div class="row">
	...
	<div class="row">
		<div class="col-md-4">
			<div class="box box-solid">
				...
				<div class="box-body">
					<p class="lead">
					    Informez-vous pour mieux maitriser
					</p>
					<p class="text-muted"> 
		...
		<div class="col-md-4">
			<div class="box box-solid">
				...
				<div class="box-body">
					<p class="lead">
					    Trouver de l'aide sur notre forum
					</p>
