...
<div class="alert alert-success">
    ...
    {{ 'Bienvenue dans' }} <?= config::byKey('product_name'); ?> {{ ', merci d\'avoir choisit cet outil pour votre habitat connecté.' '}}<br>
</div>
          ...
          <h3 class="box-title">{{ 'NextDom' }}</h3>
				...
				<div class="box-body">
					<div class="row text-center">
						<div class="col-xs-12">
							<a href="index.php?v=d&p=migration"><i class="fas fa-upload" style="font-size:14.2em;color:#33B8CC"></i></a>
						</div>
					</div>
				</div>
			</div>
