...
<center>
    <select id="mod_actionValue_sel" class="form-control">
        ...
        <option value="nextdom_poweroff">{{Arrêter NextDom}}</option>
...
<div class="alert alert-info mod_actionValue_selDescription say" style="display:none;">
    {{Permet de faire dire un texte à NextDom (ne marche que si un onglet NextDom est ouvert dans le navigateur)}}
</div>
...
<div class="alert alert-info mod_actionValue_selDescription ask" style="display:none;">
    {{Action qui permet à NextDom de faire une demande puis de stocker la réponse dans une variable. Cette action est bloquante et ne finit que si NextDom reçoit une réponse ou si le timeout est atteint. Pour le moment cette action n'est compatible qu'avec les plugins SMS, Slack, SARAH et Telegram.}}
</div>

<div class="alert alert-info mod_actionValue_selDescription nextdom_poweroff" style="display:none;">
    {{Envoi l'ordre à NextDom de s'éteindre}}
</div>
...
<div class="alert alert-info mod_actionValue_selDescription alert2" style="display:none;">
    {{Permet d'afficher un petit message d'alerte sur tous les navigateurs qui ont une page NextDom d'ouvert. Vous pouvez en plus choisir 4 niveaux d'alerte}}
</div>

<div class="alert alert-info mod_actionValue_selDescription popup" style="display:none;">
    {{Permet d'afficher un popup qui doit absolument être validé sur tous les navigateurs qui ont une page NextDom ouverte.}}
</div>
