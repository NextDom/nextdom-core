...
?>
	...
	<div class="panel panel-warning">
		...
		<div class="panel-body">
			{{La vérification en 2 étapes fournit une couche supplémentaire de protection pour votre compte NextDom. Une fois la vérification en 2 étapes configurée, votre mot de passe sera nécessaire en plus d’un code de vérification unique pour vous connecter à NextDom. Veuillez noter qu’un appareil mobile sera nécessaire pour générer des codes de vérification.}}
			<hr/>
			{{Veuillez installer une application d’authentification sur votre appareil mobile. Si vous n’en avez pas encore installé une, NextDom prend en charge les applications d’authentification suivantes : Google Authenticator (Android, iOS, BlackBerry), Authenticator (Windows Phone).}}
			<hr/>
			<strong>{{IMPORTANT : si votre NextDom n'est plus à l'heure vous ne pourrez pas vous connecter du tout}}</strong>
		</div>
