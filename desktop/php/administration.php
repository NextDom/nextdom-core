			...
			<form class="form-horizontal">
				<fieldset>
					<div class="form-group">
						<label class="col-lg-2 col-md-3 col-sm-4 col-xs-6 control-label help" data-help="{{Nom de votre NextDom (utilisé notamment par le market)}}">{{Nom de votre NextDom}}</label>
					...
					<div class="form-group">
						...
						<div class="col-lg-5 col-md-5 col-sm-6 col-xs-6">
							<span class="label label-info" style="font-size : 1em;"><?php echo nextdom::getHardwareName() ?></span>
						</div>
					...
					<div class="form-group">
						<label class="col-lg-2 col-md-3 col-sm-4 col-xs-6 control-label help" data-help="{{Clef d'installation qui permet d'identifier votre NextDom quand il communique avec le market}}">{{Clef d'installation}}</label>
						<div class="col-lg-5 col-md-5 col-sm-6 col-xs-6">
							<span class="label label-info" style="font-size : 1em;"><?php echo nextdom::getHardwareKey() ?></span>
						</div>
						<div class="col-lg-2 col-md-3 col-sm-3">
					...
					<div class="form-group">
						<label class="col-lg-2 col-md-3 col-sm-4 col-xs-6 control-label help" data-help="{{Langue de votre NextDom}}">{{Langue}}</label>
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
						...
						<div>
							...
							<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
								<input type="checkbox" class="configKey" data-l1key="generateTranslation" title="{{Option pour les développeurs permettant à NextDom de générer les phrases à traduire}}" />
							</div>
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 col-md-3 col-sm-4 col-xs-6 control-label help" data-help="{{Durée de vie de votre connexion à NextDom si vous n'avez pas coché la case enregistrer cet ordinateur}}">{{Durée de vie des sessions (heure)}}</label>
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
...
?>
					...
					<div class="form-group">
						<label class="col-lg-2 col-md-3 col-sm-4 col-xs-6 control-label help" data-help="{{Fuseau horaire de votre NextDom}}">{{Date et heure}}</label>
						<div class="col-lg-5 col-md-5 col-sm-6 col-xs-6">
					...
					<div class="form-group">
						<label class="col-lg-2 col-md-3 col-sm-4 col-xs-6 control-label help" data-help="{{Permet d'ajouter un serveur de temps à NextDom utilisé lorsque NextDom force la synchronisation de l'heure}}">{{Serveur de temps optionnel}}</label>
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
							<input type="text"  class="configKey form-control" data-l1key="ntp::optionalServer" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 col-md-3 col-sm-4 col-xs-6 control-label help" data-help="{{Indique à NextDom de ne pas prendre en compte l'heure du système}}">{{Ignorer la vérification de l'heure}}</label>
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
		...
		<div role="tabpanel" class="tab-pane" id="apitab">
			...
			<form class="form-horizontal">
				<fieldset>
					...
					<div class="form-group">
						<label class="col-lg-2 col-md-3 col-sm-4 col-xs-6 control-label help" data-help="{{Clef API globale de NextDom}}">{{Clef API}}</label>
					...
					<div class="form-group">
						<label class="col-lg-2 col-md-3 col-sm-4 col-xs-6 control-label help" data-help="{{Clef API Pro de NextDom}}">{{Clef API Pro}}</label>
						<div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
							<div class="input-group">
...
?>
		...
		<div role="tabpanel" class="tab-pane" id="ostab">
			...
			<form class="form-horizontal">
				<fieldset>
					<div class="alert alert-danger">{{ATTENTION : ces opérations sont risquées, vous pouvez perdre l'accès à votre système et à NextDom. L'équipe NextDom se réserve le droit de refuser toute demande de support en cas de mauvaise manipulation.}}</div>
...
?>
		...
		<div role="tabpanel" class="tab-pane" id="networktab">
			<br/>
			<div class="alert alert-warning">{{Attention : cette configuration n'est là que pour informer NextDom de sa configuration réseau et n'a aucun impact sur les ports ou l'IP réellement utilisés pour joindre NextDom}}</div>
			<form class="form-horizontal">
				<fieldset>
...
?>
							...
							<div class="form-group has-error">
								<label class="col-xs-6 control-label">{{Désactiver la gestion du réseau par NextDom}}</label>
								<div class="col-xs-4">
...
foreach ($repos as $key => $value) {
	...
	echo '<div class="form-group">';
	echo '<label class="col-xs-4 control-label">{{Utiliser les DNS NextDom}}</label>';
	...
	if ($configs['market::allowDNS'] == 1 && network::dns_run()) {
		...
		echo '<span class="label label-warning" title="{{Normal si vous n\'avez pas coché la case : Utiliser les DNS NextDom}}">{{Arrêté}}</span>';
	}
	echo '</div>';
	echo '</div>';
	echo '<div class="form-group">';
			...
			<form class="form-horizontal">
				<fieldset>
					<div class="alert alert-info">
						{{Attention : toute modification du moteur de cache nécessite un redémarrage de NextDom}}
					</div>
		...
		<div role="tabpanel" class="tab-pane" id="updatetab">
			...
			<div class="row">
				<div class="col-sm-6">
					<form class="form-horizontal">
						<fieldset>
							<legend>{{Mise à jour de nextdom}}</legend>
							<div class="form-group">
