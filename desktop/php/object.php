...
?>
 ...
 <div class="col-lg-10 col-md-10 col-sm-9" id="div_resumeObjectList" style="border-left: solid 1px #EEE; padding-left: 25px;">
   ...
   <div class="objectListContainer">
     <div class="iconlist" id="bt_addObject2">
       <br/>
       <center style='margin-top:-14px;'>
         <i class="fa fa-plus-circle" style="font-size : 6em;color:#33B8CC;margin-top:5px;"></i>
       </center>
     ...
     <div class="iconlist bt_showObjectSummary">
      <br/>
      <center style='margin-top:-14px;'>
  ...
  <div class="objectListContainer">
   <?php
foreach ($allObject as $object) {
    echo '<div class="objectDisplayCard iconlist" data-object_id="' . $object->getId() . '" data-object_name="' . $object->getName() . '" data-object_icon=\'' . $object->getDisplay('icon', '<i class="fa fa-lemon-o"></i>') . '\'>';
