    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom config">
            <div style="margin-top: 5px;">
                <a title="{{'Sauvegarder'}}" class="btn btn-success pull-right" id="bt_saveProfils"><i class="far fa-check-circle"></i> </a>
                ...
                <div class="tab-content" style="height:calc(100% - 50px);overflow:auto;overflow-x: hidden;">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="profil">
                        ...
                        <div class="col-sm-6">
                            <img id="monAvatar" src="<?php $_SESSION['user']->getOptions('avatar') ?>" style="width:auto; height:200px"></a>
                        </div>
                    </div>
                                        ...
                                        <div class="col-sm-3">
                                            <select class="userAttr form-control" data-l1key="options" data-l2key="bootstrap_theme">
                                                ...
                                                foreach (ls(__DIR__ . '/../../css/themes') as $dir) {
                                                    if (is_dir(__DIR__ . '/../../css/themes/' . $dir . '/desktop')) {
