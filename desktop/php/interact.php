    ...
    <section class="content">
        <div class="row row-overflow">
            <div id="interactThumbnailDisplay" class="col-xs-12">
                <div class="box">
                    <div class="box-header">       <legend><i class="fas fa-cog"></i> {{Gestion}}</legend></div>
                    <div class="box-body interactListContainer">
                ...
                <div class="box">
                    <div class="box-header">       <legend><i class="far fa-comments"></i> {{Mes interactions}}</legend>
                        <?php
                        if (count($totalInteract) == 0) {
                            ...
                            echo '</div>';
                            echo '<div class="panel-group" id="accordionInteract" style="margin:10px">';
            ...
            <div class="col-xs-12">
                <section class="interact col-xs-12 nav-tabs-custom" style="display: none;" id="div_conf">
