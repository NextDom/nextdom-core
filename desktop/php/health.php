...
?>
<br/>
<legend style=""><i class="icon divers-caduceus3" style=""></i> {{Santé de NextDom}}
    <i class="fas fa-tachometer-alt pull-right cursor" id="bt_benchmarkNextDom"></i>
</legend>
<table class="table table-condensed table-bordered">
    <thead><tr><th style="width : 250px;"></th><th style="width : 500px;">{{Résultat}}</th><th style="">{{Conseil}}</th></tr></thead>
    <tbody>
        <?php
foreach (nextdom::health() as $datas) {
    echo '<tr>';
