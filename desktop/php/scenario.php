        ...
        <div class="row row-overflow" >
            <div id="scenarioThumbnailDisplay" class="col-xs-12" style="border-left: solid 1px #EEE; padding-left: 25px;">
                <div class="box">
                    ...
                    <div class="box-body scenarioListContainer">
                        <div class="cursor" id="bt_addScenario2" style="text-align: center; height : 130px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 170px;margin-left : 10px;" >
                            <i class="fas fa-plus-circle" style="font-size : 6em;color:#33B8CC;"></i>
                            <br>
                ...
                <div class="box">
                    <div class="box-header"> <legend><i class="icon nextdom-clap_cinema"></i>  {{Mes scénarios}}</legend>
                        <?php
                        if (count($totalScenario) == 0) {
                            ...
                            echo '</div>';
                            echo '<div class="box-body panel-group" id="accordionScenar">';
