...
<div id="scenarioThumbnailDisplay" class="col-xs-10 text-center" style="border-left: solid 1px #EEE; padding-left: 25px;">
 <div class="scenarioListContainer">
   <legend><i class="fa fa-cog"></i>  {{Gestion}}</legend>
   <div class="iconlist" id="bt_addScenario2">
  ...
  <?php if (config::byKey('enableScenario') == 0) {?>
    <div class="iconlist" id="bt_changeAllScenarioState2" data-state="1">
   ...
   <?php } else {?>
   <div class="iconlist" id="bt_changeAllScenarioState2" data-state="0">
...
?>
   ...
   <div class="iconlist" id="bt_displayScenarioVariable2">
  ...
  <div class="iconlist bt_showScenarioSummary">
  ...
  <div class="iconlist bt_showExpressionTest">
...
if (count($totalScenario) == 0) {
    ...
    if (count($scenarios[-1]) > 0) {
        ...
        foreach ($scenarios[-1] as $scenario) {
            ...
            echo '<div class="scenarioDisplayCard iconlist" data-scenario_id="' . $scenario->getId() . '" style="text-align: center; background-color : #ffffff; min-height : 140px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;' . $opacity . '" >';
