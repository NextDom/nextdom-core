...
Utils::sendVarToJS('market_display_info', array(
    'logicalId' => init('logicalId'),
    'name' => init('name'),
));
Utils::sendVarToJS('market_type', Utils::init('type'));
try {
...
if (is_object($market) && !$market->getIsAuthor()) {
    throw new CoreException('{{Vous n\'êtes pas l\'auteur du plugin}}');
}

if (init('type') == 'plugin') {
    $plugin = PluginManager::byId(init('logicalId'));
    if (!is_object($plugin)) {
        throw new CoreException('{{Le plugin :}} ' . init('logicalId') . ' {{est introuvable}}');
    }
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    ...
                    <select class="form-control widget category" data-l1key="categorie" style="display: none;">
                        <?php
                        foreach (RepoMarket::distinctCategorie('widget') as $id => $category) {
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <label class="checkbox-inline">
                            <input type="checkbox" class="marketAttr" data-l1key="hardwareCompatibility" data-l2key="NextDomboard"> NextDomboard (mini+)
                        </label>
                        <label class="checkbox-inline">
...
<?php
if (is_object($market)) {
    Utils::sendVarToJS('market_display_info', Utils::o2a($market));
}
?>
<script>
