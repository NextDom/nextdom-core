...
class FoldersReferential extends Enum
{
    ...
    const NEXTDOMFOLDERS = ['api','assets','backup','core','data','docs','install','log','mobile','plugins','public','scripts','src','tests','translations','vendor','views','var','.github','.sass-cache','.git','.idea'];
