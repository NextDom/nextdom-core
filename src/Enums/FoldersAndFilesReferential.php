...
class FoldersAndFilesReferential extends Enum
{
    ...
    const NEXTDOM_ROOT_FOLDERS = [
        NextDomFolder::API,
        NextDomFolder::ASSETS,
        NextDomFolder::BACKUP,
        NextDomFolder::CORE,
        NextDomFolder::DATA,
        NextDomFolder::DOCS,
        NextDomFolder::INSTALL,
        NextDomFolder::LOG,
        NextDomFolder::MOBILE,
        NextDomFolder::NODE_MODULES,
        NextDomFolder::PLUGINS,
        NextDomFolder::PUBLIC,
        NextDomFolder::SCRIPTS,
        NextDomFolder::SRC,
        NextDomFolder::TESTS,
        NextDomFolder::TMP,
        NextDomFolder::TRANSLATIONS,
        NextDomFolder::VENDOR,
        NextDomFolder::VIEWS,
        NextDomFolder::VAR,
        NextDomFolder::_GITHUB,
        NextDomFolder::_SASS_CACHE,
        NextDomFolder::_GIT,
        NextDomFolder::_IDEA
    ];
