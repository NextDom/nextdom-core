...
/*     * *********************DNS************************* */
    ...
    public static function dns_create() {
        ...
        $openvpn = eqLogic::byLogicalId('dnsnextdom', 'openvpn');
        ...
        $openvpn->setConfiguration('remote_host', 'vpn.dns' . config::byKey('dns::number', 'core', 1) . '.nextdom.com');
        $openvpn->setConfiguration('username', nextdom::getHardwareKey());
...
/*     * *********************Network management************************* */
    ...
    public static function cron5() {
        ...
        if (!nextdom::isCapable('sudo') || nextdom::getHardwareName() == 'docker') {
            return;
        }
