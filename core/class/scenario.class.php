...
class scenario
{
    ...
    public function copy($_name)
    {
        ...
        $scenarioCopy->setLog('');
        $scenarioCopy->save();
        if (file_exists(dirname(__FILE__) . '/../../var/logs/scenarioLog/scenario' . $scenarioCopy->getId() . '.log')) {
            unlink(dirname(__FILE__) . '/../../var/logs/scenarioLog/scenario' . $scenarioCopy->getId() . '.log');
        }
        return $scenarioCopy;
    }
    ...
    public function remove()
    {
        ...
        $this->emptyCacheWidget();
        if (file_exists(dirname(__FILE__) . '/../../var/logs/scenarioLog/scenario' . $this->getId() . '.log')) {
            unlink(dirname(__FILE__) . '/../../var/logs/scenarioLog/scenario' . $this->getId() . '.log');
        }
    ...
    public function persistLog($_partial = false)
    {
        ...
        $path = dirname(__FILE__) . '/../../var/logs/scenarioLog';
        if (!file_exists($path)) {
            mkdir($path);
        }
