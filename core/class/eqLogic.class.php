...
class eqLogic {
    ...
    public function batteryWidget($_version = 'dashboard') {
        ...
        $html .= '<div style="text-align : center;font-size:2.2em;font-weight: bold;margin-top:-25px;margin-bottom:-25px"><i class="icon nextdom-batterie' . $niveau . ' tooltips" title="' . $this->getStatus('battery', -2) . '%" style="font-size :2.5em;"></i></div>';
    ...
    public function getUsedBy($_array = false) {
        ...
        $return['eqLogic'] = EqLogicManager::searchConfiguration('#eqLogic' . $this->getId() . '#');
        $return['eqLogic'] = array_merge($return['eqLogic'], EqLogicManager::searchConfiguration('"eqLogic":"' . $this->getId()));
