...
class repo_github {
    ...
    public static function getGithubClient() {
        $client = new \Github\Client(
            new \Github\HttpClient\CachedHttpClient(array('cache_dir' => nextdom::getTmpFolder('github') . '/cache'))
        );
    ...
    public static function downloadObject($_update) {
        ...
        $tmp_dir = nextdom::getTmpFolder('github');
    ...
    public static function downloadCore($_path) {
        $client = self::getGithubClient();
        try {
            $client->api('repo')->branches(config::byKey('github::core::user', 'core', 'nextdom'), config::byKey('github::core::repository', 'core', 'core'), config::byKey('github::core::branch', 'core', 'stable'));
        } catch (Exception $e) {
            throw new Exception(__('Dépot github non trouvé : ', __FILE__) . config::byKey('github::core::user', 'core', 'nextdom') . '/' . config::byKey('github::core::repository', 'core', 'core') . '/' . config::byKey('github::core::branch', 'core', 'stable'));
        }
        $url = 'https://api.github.com/repos/' . config::byKey('github::core::user', 'core', 'nextdom') . '/' . config::byKey('github::core::repository', 'core', 'core') . '/zipball/' . config::byKey('github::core::branch', 'core', 'stable');
    ...
    public static function versionCore() {
        try {
            $client = self::getGithubClient();
            $fileContent = $client->api('repo')->contents()->download(config::byKey('github::core::user', 'core', 'nextdom'), config::byKey('github::core::repository', 'core', 'core'), 'core/config/version', config::byKey('github::core::branch', 'core', 'stable'));
