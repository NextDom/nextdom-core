...
class ScenarioControllerTest extends BaseControllerTest
{
    ...
    public function testSimple()
    {
        ...
        $this->assertEquals(3, $pageData['scenarioCount']);
    ...
    {
        $pageData = [];
        \NextDom\Controller\Tools\ScenarioController::get($pageData);
        $this->pageDataVars('desktop/tools/scenario.html.twig', $pageData);
    }
}
