...
class FirstUsePage(BaseGuiTest):
    ...
    def test_first_use_shortcuts(self): #pylint: disable=too-many-statements
        ...
        productname_button = self.get_element_by_id('in_change_productname')
        adminlte_widget_theme_checkbox = self.get_element_by_css('input[value="adminlte"]')
        flat_widget_theme_checkbox = self.get_element_by_css('input[value="flat"]')
        step_4_button = self.get_element_by_id('toStep4')
        step_5_button = self.get_element_by_id('toStep5')
        step_6_button = self.get_element_by_id('toStep6')
        ...
        self.assertFalse(productname_button.is_displayed())
        self.assertFalse(adminlte_widget_theme_checkbox.is_displayed())
        self.assertFalse(flat_widget_theme_checkbox.is_displayed())
        self.assertFalse(step_6_button.is_displayed())
        ...
        self.assertFalse(dark_theme_checkbox.is_displayed())
        self.assertFalse(step_5_button.is_displayed())
        self.assertTrue(productname_button.is_displayed())
        self.assertTrue(adminlte_widget_theme_checkbox.is_displayed())
        self.assertTrue(flat_widget_theme_checkbox.is_displayed())
        self.assertTrue(step_6_button.is_displayed())
        self.assertFalse(finish_button.is_displayed())
    ...
    def test_full_process(self): #pylint: disable=too-many-statements
        ...
        self.assertTrue(step_6_button.is_displayed())
        self.assertFalse(finish_button.is_displayed())
        productname_button.send_keys('nextdom')
        adminlte_widget_theme_checkbox.click()
        step_6_button.click()
        # Step 6
        sleep(5)
        self.assertFalse(step_2_button.is_displayed())
