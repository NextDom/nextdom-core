...
class AdministrationPages(unittest.TestCase):
    ...
    @classmethod
    def go_to_administration(cls):
        # Wait for dashboard objets loading
        sleep(4)
        # Put the mouse hover the menu to show the administration link
        menu_to_hover = cls.driver.find_element_by_css_selector('.treeview>a>i.fa-cog')
        menu_hover_action = ActionChains(cls.driver).move_to_element(menu_to_hover)
        menu_hover_action.perform()
        # Wait for mouse event
        sleep(2)
        # Click on menu item
        cls.driver.find_element_by_css_selector('a[href="index.php?v=d&p=administration"]').click()

    def test_administration_page(self):
        # Wait for loding page
        sleep(2)
    ...
    def test_users_page(self):
        self.driver.find_element_by_css_selector('a[href="index.php?v=d&p=users"]').click()
        sleep(4)
    ...
    def test_api_page(self):
        self.driver.find_element_by_css_selector('a[href="index.php?v=d&p=api"]').click()
        sleep(4)
    ...
    def test_network_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=network"]').click()
        sleep(4)
    ...
    def test_security_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=security"]').click()
        sleep(4)
    ...
    def test_cache_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=cache"]').click()
        sleep(4)
    ...
    def test_service_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=update_admin"]').click()
        sleep(4)
    ...
    def test_general_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=general"]').click()
        sleep(4)
    ...
    def test_custom_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=custom"]').click()
        sleep(4)
    ...
    def test_profils_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=profils"]').click()
        sleep(4)
    ...
    def test_commandes_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=commandes"]').click()
        sleep(4)
    ...
    def test_links_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=links"]').click()
        sleep(4)
    ...
    def test_interact_admin_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=interact_admin"]').click()
        sleep(4)
    ...
    def test_eqlogic_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=eqlogic"]').click()
        sleep(4)
    ...
    def test_summary_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=summary"]').click()
        sleep(4)
    ...
    def test_reports_admin_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=reports_admin"]').click()
        sleep(4)
    ...
    def test_log_admin_page(self):
        self.driver.find_element_by_xpath('//a[@href="index.php?v=d&p=log_admin"]').click()
        sleep(4)
