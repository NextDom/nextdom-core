...
$js_file = array(
    ...
    '/assets/3rdparty/jquery.mobile/jquery.mobile.min.js',
    '/assets/3rdparty/jquery.mobile/nativedroid2.js',
...
$other_file = array(
    ...
    '/assets/3rdparty/jquery.mobile/jquery.mobile.min.css',
    '/assets/3rdparty/jquery.mobile/css/nativedroid2.css',
    '/assets/3rdparty/jquery.mobile/css/fonts.css',
    '/assets/3rdparty/jquery.mobile/css/flexboxgrid.min.css',
    '/assets/3rdparty/jquery.mobile/css/material-design-iconic-font.min.css',
    '/vendor/node_modules/node-waves/dist/waves.css',
    '/assets/3rdparty/jquery.utils/jquery.utils.css',
    ...
    '/assets/3rdparty/jquery.mobile/images/ajax-loader.gif',
    '/public/img/icon-128x128.png',
    '/public/img/icon-25x25.png',
    '/vendor/node_modules/font-awesome5/webfonts/fa-solid-900.woff2',
    '/assets/3rdparty/jquery.mobile/css/fonts/fontawesome-webfont.woff2?v=4.3.0',
    ...
    '/assets/3rdparty/jquery.mobile/css/fonts/roboto/Roboto-Medium-webfont.woff',
