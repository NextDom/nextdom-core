...
class DataStorageTest extends TestCase
{
    ...
    {
        DB::prepare('DROP TABLE ' . $this->realTableName);
    }
    ...
    {
        DB::prepare("CREATE TABLE `" . $this->dataTableName . "` (`id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY, `code` VARCHAR(256) NOT NULL, `data` TEXT NULL)");
