...
nextdom.plan3d.byId = function (queryParams) {
  ...
  if (nextdom.private.isValidQuery(queryParams, paramsRequired, paramsSpecifics)) {
    var params = $.extend({}, nextdom.private.default_params, paramsSpecifics, queryParams || {});
    var ajaxParams = nextdom.private.getParamsAJAX(params, 'Plan3d', 'get');
    ajaxParams.data['id'] = queryParams.id;
    $.ajax(ajaxParams);
  }
};
...
nextdom.plan3d.byplan3dHeader = function (queryParams) {
  ...
  if (nextdom.private.isValidQuery(queryParams, paramsRequired, paramsSpecifics)) {
    var params = $.extend({}, nextdom.private.default_params, paramsSpecifics, queryParams || {});
    var ajaxParams = nextdom.private.getParamsAJAX(params, 'Plan3d', 'plan3dHeader');
    ajaxParams.data['plan3dHeader_id'] = queryParams.plan3dHeader_id;
    $.ajax(ajaxParams);
  }
};
...
nextdom.plan3d.removeHeader = function (queryParams) {
  ...
  if (nextdom.private.isValidQuery(queryParams, paramsRequired, paramsSpecifics)) {
    var params = $.extend({}, nextdom.private.default_params, paramsSpecifics, queryParams || {});
    var ajaxParams = nextdom.private.getParamsAJAX(params, 'Plan3d', 'removeplan3dHeader');
    ajaxParams.data['id'] = queryParams.id;
    $.ajax(ajaxParams);
  }
};
...
nextdom.plan3d.getHeader = function (queryParams) {
  ...
  if (nextdom.private.isValidQuery(queryParams, paramsRequired, paramsSpecifics)) {
    var params = $.extend({}, nextdom.private.default_params, paramsSpecifics, queryParams || {});
    var ajaxParams = nextdom.private.getParamsAJAX(params, 'Plan3d', 'getplan3dHeader');
    ajaxParams.data['id'] = queryParams.id;
